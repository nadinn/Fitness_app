...
public class MyHelperBack extends SQLiteOpenHelper {
    private static final String DB_NAME = "DatabaseBack";
    ...
    public MyHelperBack(Context context) {
