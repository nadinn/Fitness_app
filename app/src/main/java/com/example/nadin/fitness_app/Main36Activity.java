/**
 * CHEST EXERCISE 4 - DATABASE POPULATION + GRAPH
 */
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (temp > 0) {
                        ...
                        if (deleteTuple > 0) {
                            Toast.makeText(Main36Activity.this, "Row deleted", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(Main36Activity.this, "Please enter a valid ID", Toast.LENGTH_LONG).show();
                        }

                    } else {
                        Toast.makeText(Main36Activity.this, "Please enter ID to delete", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
