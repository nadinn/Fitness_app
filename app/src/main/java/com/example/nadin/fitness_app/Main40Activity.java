/**
 * GLUTES EXERCISE 4 - DATABASE POPULATION + GRAPH
 */
...
public class Main40Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myHelper = new MyHelperGlutes(this);
    ...
    public void inputMethod() {
        input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (insertData == true) {
                    Toast.makeText(Main40Activity.this, "Data added ", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Main40Activity.this, "Data not added ", Toast.LENGTH_LONG).show();
                }
    ...
    public void viewData() {
        viewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Cursor data = myHelper.showData4();
    ...
    public void deleteData(){
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (temp > 0) {
                    Integer deleteTuple = myHelper.deleteData4(idValue.getText().toString());
                    if (deleteTuple > 0) {
                        Toast.makeText(Main40Activity.this, "Row deleted", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(Main40Activity.this, "Please enter a valid ID", Toast.LENGTH_LONG).show();
                    }

                } else {
                    Toast.makeText(Main40Activity.this, "Please enter ID to delete", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
