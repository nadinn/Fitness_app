...
public class MyHelperGlutes extends SQLiteOpenHelper {
    private static final String DB_NAME = "DatabaseGlutes";
    ...
    public MyHelperGlutes(Context context) {
